...
${OBJECTDIR}/src/bitFlip.o: src/bitFlip.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -s -DEXTERNALTABLE -DNDEBUG -DYESASSEMBLR -Iinclude -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/bitFlip.o src/bitFlip.cpp

${OBJECTDIR}/src/bitFlipAVX.o: src/bitFlipAVX.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -s -DEXTERNALTABLE -DNDEBUG -DYESASSEMBLR -Iinclude -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/bitFlipAVX.o src/bitFlipAVX.cpp
...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/bitFlip: ${TESTDIR}/tests/bitFlipTest.o ${TESTDIR}/tests/bitFlipTestSuite.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/bitFlip $^ ${LDLIBSOPTIONS}   -lgtest -lbenchmark 


${TESTDIR}/tests/flipBits.o: tests/flipBits.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -s -DEXTERNALTABLE -DNDEBUG -DYESASSEMBLR -Iinclude -I/usr/include -I. -std=c++14 -Ofast -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/flipBits.o tests/flipBits.cpp


${TESTDIR}/tests/bitFlipTest.o: tests/bitFlipTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -s -DEXTERNALTABLE -DNDEBUG -DYESASSEMBLR -Iinclude -I/usr/include -std=c++14 -Ofast -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/bitFlipTest.o tests/bitFlipTest.cpp


${TESTDIR}/tests/bitFlipTestSuite.o: tests/bitFlipTestSuite.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -s -DEXTERNALTABLE -DNDEBUG -DYESASSEMBLR -Iinclude -I/usr/include -std=c++14 -Ofast -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/bitFlipTestSuite.o tests/bitFlipTestSuite.cpp
...
${OBJECTDIR}/src/bitFlip_nomain.o: ${OBJECTDIR}/src/bitFlip.o src/bitFlip.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -s -DEXTERNALTABLE -DNDEBUG -DYESASSEMBLR -Iinclude -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/bitFlip_nomain.o src/bitFlip.cpp;\
	else  \
...
${OBJECTDIR}/src/bitFlipAVX_nomain.o: ${OBJECTDIR}/src/bitFlipAVX.o src/bitFlipAVX.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -s -DEXTERNALTABLE -DNDEBUG -DYESASSEMBLR -Iinclude -std=c++14 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/bitFlipAVX_nomain.o src/bitFlipAVX.cpp;\
	else  \
