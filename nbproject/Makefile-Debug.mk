...
${OBJECTDIR}/bitFlip.o: bitFlip.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/C/msys2/mingw64/include  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/bitFlip.o bitFlip.cpp
...
${TESTDIR}/TestFiles/f1: ${TESTDIR}/tests/bitFlipTest.o ${TESTDIR}/bitFliptSuite.o ${OBJECTFILES:%.o=%_nomain.o}
	...
	${LINK.cc} -o ${TESTDIR}/TestFiles/f1 $^ ${LDLIBSOPTIONS}   -lgtest.dll 


${TESTDIR}/tests/bitFlipTest.o: tests/bitFlipTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/C/msys2/mingw64/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/bitFlipTest.o tests/bitFlipTest.cpp


${TESTDIR}/bitFliptSuite.o: bitFliptSuite.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/C/msys2/mingw64/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/bitFliptSuite.o bitFliptSuite.cpp
...
${OBJECTDIR}/bitFlip_nomain.o: ${OBJECTDIR}/bitFlip.o bitFlip.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I/C/msys2/mingw64/include  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/bitFlip_nomain.o bitFlip.cpp;\
	else  \
